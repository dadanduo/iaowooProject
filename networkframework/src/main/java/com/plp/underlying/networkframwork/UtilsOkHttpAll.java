...
public class UtilsOkHttpAll {
     ...
     * H5页面url
     */
    public static  int  H5STATUS=3;
    /**
     * weex頁面http
     */
    public static  int  WEEXSTATUS=1;
    /*
     * 服务器路径接口
     */
    ...
    static {
        String[] HTTP_URL_S = {
                //山苗姐本地
                "http://192.168.1.112:8881",
                "http://172.16.4.8:9989",
                "https://test-api.iaowoo.com",
                "https://api.iaowoo.com",
                "https://stage-api.shbs008.com",
                "https://api.shbs008.com",
                //开发环境
                "https://dev-api.shbs008.com"};
        HTTP_BASE =  HTTP_URL_S[STATUS];//配置服务器接口域名
    }
    /********************************************************接口配置区域*********************************************/
