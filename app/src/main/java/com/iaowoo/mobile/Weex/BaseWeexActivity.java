...
public abstract class BaseWeexActivity extends AppCompatActivity implements IWXRenderListener {
    ...
    private void registerWeexReceiver() {
        registerReceiver(receiver, new IntentFilter(ZApplication.BC_ACTION_RENDER_NET_JS));
    }
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (ZApplication.BC_ACTION_RENDER_NET_JS.equals(action)) {
    ...
    protected void renderLocalWeexPage(String jsName) {
        ...
        renderWeexPage(RENDER_TYPE_LOCAL, ZApplication.LOCAL_FILE_SCHEMA + jsName, jsName);
    }
