...
public class JsMethod {
    ...
    public JsMethod(JsCallBack jsCallBack) {
    ...
    public  void Alipay(Context context,String data)
    {
        ...
        if(payAlipaySoftReference.get()!=null) {
            ...
            SoftReference<PayAlipay> payAlipaySoftReference1=new SoftReference<>(new PayAlipay(context));
            payAlipaySoftReference1.get().startPay(data);
        }
     ...
     * @param context
     */
    public  void authorization(SHARE_MEDIA share_media,final Context context) {
