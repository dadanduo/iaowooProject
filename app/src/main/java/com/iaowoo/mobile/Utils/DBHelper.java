...
public class DBHelper extends SQLiteOpenHelper {
	...
	// 数据库文件目标存放路径为系统默认位置，com.iaowoo.mobile 是你的包名
	private static String DB_PATH = "/data/data/com.iaowoo.mobile/databases/";
	/*
	 * //如果你想把数据库文件存放在SD卡的话 private static String DB_PATH =
	 * android.os.Environment.getExternalStorageDirectory().getAbsolutePath() +
	 * "/arthurcn/drivertest/packfiles/";
	 */
	private static String DB_NAME = "plp_cities.db";
	private static String ASSETS_NAME = "plp_cities.db";
	...
	public void createDataBase() throws IOException {
		...
		if (dbExist) {
			...
			try {
				...
				LogPrint.print("数据库创建失败"+e.getMessage(),4);
