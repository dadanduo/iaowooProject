...
public class CaptureManager {
    ...
    private ZxingCodeCallBack zxingCodeCallBack;
    ...
    public void setCallBack(ZxingCodeCallBack zxingCodeCallBack)
    {
        this.zxingCodeCallBack=zxingCodeCallBack;
    }
...
//        finish();
        ...
        zxingCodeCallBack.getCode_msm("timeout");
...
//        activity.setResult(Activity.RESULT_OK, intent);
        LogPrint.printError("结果"+rawResult);
        zxingCodeCallBack.getCode_msm(rawResult+"");
//        finish();
    }
    ...
    public interface ZxingCodeCallBack {
        void getCode_msm(String msm);
    }
}
