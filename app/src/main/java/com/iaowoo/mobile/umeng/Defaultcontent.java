...
public class Defaultcontent {
     ...
     *小程序的id
     */
    public static String small_id="gh_6819c859b13b";
    public static String url = ConfigH5Url.HTTP_H5+"/#/down";
    public static String text = "我发现了一款年轻化、时尚化和生活化，具有高性价比商品的APP，赶快来下载试试吧！";
    public static String title = "爱好物";
