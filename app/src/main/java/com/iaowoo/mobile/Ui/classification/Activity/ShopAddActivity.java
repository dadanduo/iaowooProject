...
// * @author ${chenda}
// * @version V1.0
// * @Description: ${todo}(商家联盟activity)
// * @date 2018/11/15
// * @email ${18011009889@163.com}
// */
//public class ShopAddActivity extends BaseUpDownActivity implements LocationApiUtils.LocationCallBack, OnLocationGetListener, ShopAddFragementPresenter.ShopCallBack {
...
//        super.initView();
//        regeocodeTask = new RegeocodeTask(this);
...
//        shopAddFragementProsenter = new ShopAddFragementPresenter(this, this);
//
//        nearShopsRecycleAdapter = new NearShopsRecycleAdapter(this, new ItemClickInterface() {
//            @Override
...
//
//        //头部
//        View view = LayoutInflater.from(this).inflate(R.layout.s_j_b_j, null);
...
//
//
//        RegeocodeGetAddress regeocodeGetAddress=new RegeocodeGetAddress(this);
//        //城市不为空
...
//     * @param view
//     */
//    @OnClick({R.id.map, R.id.back_search_two,R.id.retun_image})
//    public void click(View view) {
//        switch (view.getId()) {
//            case R.id.map:
//                startActivity(DifferentIndustryAllianceActivity.class);
//                break;
//            case R.id.back_search_two:
//                requestPermissionWrite();
//                break;
//            case R.id.retun_image:
//                finish();
//                break;
//            default:
//                break;
...
//            dialogUtils.AlertDilog(this, "温馨提示", "你当前定位城市为" + entity.cityName + "你确定切换到"+entity.cityName+"吗？", "确定", "取消", new alertCallBack() {
//                @Override
//                public void OnOk() {
...
//        NearList.add("30km");
//        dotHaveShops.setVisibility(View.GONE);
//        NearRecycleAdapter nearRecycleAdapter = new NearRecycleAdapter(this, NearList, new ItemClickInterface() {
//            @Override
//            public void onItemClick(Object Item, int position) {
//                showT.cancel();
...
//        initDatas();
//        NearRecycleAdapter nearRecycleAdapter = new NearRecycleAdapter(this, NearShop, new ItemClickInterface() {
//            @Override
//            public void onItemClick(Object Item, int position) {
...
//        Mylayout mLayoutManager = new Mylayout(this, LinearLayoutManager.VERTICAL, false);
