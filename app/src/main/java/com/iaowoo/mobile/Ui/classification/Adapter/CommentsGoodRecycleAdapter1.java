...
public class CommentsGoodRecycleAdapter1 extends RecyclerView.Adapter{
    ...
    public CommentsGoodRecycleAdapter1(Context context, GlideUtils glideUtils) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        holder.grideView.setOnItemClickListener(new LGNineGrideView.OnItemClickListener() {
            ...
            public void onClickItem(int position1, View view) {
                LogPrint.printError("你点老子搞啥"+position);
