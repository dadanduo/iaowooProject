package com.iaowoo.mobile.Ui.classification.View.DouYinMusic;
...
import com.iaowoo.mobile.Utils.WeakWrapperHandler;
...
public class MusicalNoteLayout extends RelativeLayout implements WeakWrapperHandler.MessageHandler {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultSize = UtilsAll.dip2px(getContext(), DEFAULT_MUSIC_VIEW_SIZE);
        int musicViewSize;
        ...
        params.rightMargin = UtilsAll.dip2px(getContext(), 20);
        params.bottomMargin = UtilsAll.dip2px(getContext(), 28);
